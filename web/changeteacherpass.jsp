...
<head>
	...
	<title>Faculty Password Change</title>
...
function fun3()
{
	var name=document.changefpassword.uname.value;
	var pass=document.changefpassword.passwd.value;
	var pass2=document.changefpassword.passwd2.value;
	var pass1=document.changefpassword.passwd1.value;
	if(name =="" || pass == "" || pass1 == "" || pass2 == "")
	{
			alert("All the fields are mandatory");
			document.changefpassword.uname.focus();
			return false;
	}
}
</script>
...
<form name="changefpassword" onsubmit="return fun3()">
...
<tr>
<th align=left>Enter your EID :</th><td align=left><input type=text name=uname size=37></td>
</tr>
<tr>
...
<%
try{
	String str,str1,str2,str3,str4,str5,sql,sql1;
	int flag=0, flag1=0;
	...
	if(str3.compareTo(str4)==0)
	{
		...
		if(flag==1 && flag1==1)
		{
			sql1 = "update teacher set password='"+str3+"' where EID='"+str1+"'";
			s.execute(sql1);
			%><jsp:forward page="facultyhome.jsp"/> <%
		}
		else if(flag==0)
		{
			out.println("No Entry Found For This EID");
		}
		else if(flag1==0)
		{
